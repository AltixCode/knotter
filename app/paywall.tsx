...
const BENEFITS = ["Every pack unlocked — 500+ boards from 5x5 to 12x12","No ads, ever","Unlimited hints","The full daily archive and streak history"];
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background, paddingTop: insets.top }}>
      ...
      <ScrollView contentContainerStyle={{ padding: spacing.xl, paddingBottom: spacing['3xl'] }}>
        <Text variant="display">Knotter Pro</Text>
        <Text variant="body" tone="muted" style={{ marginTop: spacing.sm }}>
          One continuous cord per colour. Fill the board, cross nothing.
        </Text>
