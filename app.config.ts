...
/**
 * Store identity and native configuration for Knotter.
 *
...
const TRACKING_USAGE =
  'This lets us show you ads that are more relevant to you. Your data is never sold, and Knotter works exactly the same either way.';
...
const config: ExpoConfig = {
  ...
  backgroundColor: '#140A11',
  primaryColor: '#F472B6',
  assetBundlePatterns: ['**/*'],
  ios: {
    bundleIdentifier: 'com.altixcode.knotter',
    buildNumber: BUILD,
    supportsTablet: true,
